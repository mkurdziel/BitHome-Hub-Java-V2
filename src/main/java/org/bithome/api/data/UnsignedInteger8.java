...
public class UnsignedInteger8 extends Number implements Comparable<UnsignedInteger8> {
     ...
     *
     * @param pValue The short to be represented as an unsigned 8-bit integer
     *               object.
    ...
    public UnsignedInteger8(int pValue)
            throws NumberFormatException {
        setValue((short)pValue);
    }
     ...
     *
     * @param pValue The string to be represented as an unsigned 8-bit integer.
     * @throws NumberFormatException If the number is out of range.
     */
     ...
     */
    private void setValue(short pValue)
            throws NumberFormatException {
     ...
     * this object.
     *
     * @param pObj The object to compare.
